...
//--------------------------Average and Median Checkpoint----------------------------------------------//
    ...
    if(currentStreakBets.length > 10){
        if(engine.median(25) > 2.4 && engine.median() > 2){
            log("Medians are high enough to start betting again.");
            Bettable2 = true;
        }else if(engine.median(25) > 2.5 && engine.median(35) > 2 && engine.median() > 1.90){
            log("Medians are high enough to start betting again.");
            Bettable2 = true;
        }else{
            log("Medians are not high enough to bet with current bet array.");
            Bettable2 = false;
        }
    }
